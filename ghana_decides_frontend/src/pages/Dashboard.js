            ...
            <div className="absolute inset-0 flex items-center justify-center">
                <div className="grid grid-cols-12 gap-5 mx-10 h-screen p-5 overflow-hidden">
                    ...
                    <div className="col-span-3 p-4 bg-white bg-opacity-25 backdrop-blur-lg rounded-lg flex items-center justify-center overflow-y-auto hide-scrollbar">
                        <div className="mr-5  min-w-full grid grid-cols-1">
                            {[...Array(10)].map((_, index) => (
                                <div key={index} className="bg-black bg-opacity-25 backdrop-blur-lg rounded-lg flex items-center justify-center p-3 w-full m-3" style={{ boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)' }}>
                                    <div className="grid grid-cols-5 gap-1">
                                        ...
                                        <div className="col-span-1 flex items-center justify-center">
                                            <div>
                                                <img src={konedu} alt="Image 1" className="rounded h-10 w-10" />
                                                <p className='text-black text-lg font-bold' style={{ textShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)' }}>NDP</p>
                                            </div>
                                        </div>
                                        <div className="col-span-5 rounded  bg-white bg-opacity-25 p-1" >
                                            <div className='grid grid-cols-2'>
                                                <div className='col-span-1'>
                                                    <p className='text-white text-lg font-bold' style={{ textShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)' }}>KWABRE EAST</p>
                                                    <p className='text-white text-sm' style={{ textShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)' }}>CONSTITUENCY</p>
                                                </div>
                                                <div className='col-span-1 text-center items-center justify-center'>
                                                    <p className='text-white' style={{ textShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)' }}>6,345,454 votes</p>
                                                    <p className='text-white text-xl font-bold' style={{ textShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)' }}>51.3%</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
