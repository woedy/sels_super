...
export default function MapSideNav(props) {
    ...
    return (
        <>
            <div className="col-span-1 bg-black bg-opacity-25 backdrop-blur-lg rounded-lg flex flex-col items-center justify-center " style={{ boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)' }}>
