                    ...
                    <div className="h-full col-span-11 bg-white bg-opacity-25 backdrop-blur-lg rounded-lg flex items-center justify-center">
                        ...
                        <div className='h-full w-full m-3  '>
                            ...
                            <div className='grid grid-cols-2 m-5'>
                                ...
                                <p className='text-white text-left text-2xl font-bold mb-3 mt-3' style={{ textShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)' }}>LATEST PRESIDENTIAL RESULTS</p>


                                <p className='text-green-700 text-right text-2xl font-bold mb-3 mt-3' >ALL REGIONS</p>
...
export default LatestResultList;
