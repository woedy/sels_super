...
const RegisterDataAdminIDCard = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        if (!idCard) {
            setInputError('Please upload an ID card');
            return;
        }
    
        // Add additional validation logic here if needed
    
        // Add idCard to the payload
        ...
        navigate('/register-data-admin-password', { state: { updatedPayload } });
                            ...
                            <div className="sm:col-span-12 flex flex-col items-center">
                                ...
                                {idCard && (
                                    <div className="relative mt-2">
                                        <img src={idCard} alt="Uploaded" className="w-80 h-40 object-cover  border-2 border-white" />
                                        <button
...
export default RegisterDataAdminIDCard;
