...
const RegisterPresenterPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const url = baseUrl + "api/accounts/register-presenter/";
        ...
        try {
            ...
            navigate('/register-presenter-Verify',  { state: { email } }); // Navigate to success page
        } catch (error) {
...
export default RegisterPresenterPassword;
