...
const RegisterPresenterSuccessful = () => {
        ...
        <BackgroundImage imageUrl={`${process.env.PUBLIC_URL}/ghana_decides_back.png`}>
            <div className="relative flex flex-col items-center justify-center h-full">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="block mx-auto" onClick={() => navigate('/login-presenter')}>
                        {loading ? (
                            <div role="status">
...
export default RegisterPresenterSuccessful;