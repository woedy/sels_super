class ElectionPresidentialCandidatesModel {
  String? message;
  List<Data>? data;

  ElectionPresidentialCandidatesModel({this.message, this.data});

  ElectionPresidentialCandidatesModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  String? electionPrezId;
  Candidate? candidate;
  int? totalVotes;
  String? totalVotesPercent;
  int? parliamentarySeat;
  String? createdAt;
...
class Candidate {
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['prez_can_id'] = this.prezCanId;
