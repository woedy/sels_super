...
Future<ElectionPresidentialCandidatesModel>
    get_election_presidential_candidates() async {
  ...
  if (response.statusCode == 200) {
    ...
    if (result != null) {}
    return ElectionPresidentialCandidatesModel.fromJson(
...
class _EnterPresidentialResultScreen2State
    extends State<EnterPresidentialResultScreen2> {
  List<TextEditingController> textControllers = [];
  GlobalKey<FormState> formKey = GlobalKey<FormState>();
  late Future<ElectionPresidentialCandidatesModel>
      _futureGetPresidentialCandidate;
  ...
  void submit_vote(BuildContext context, _presidentialCandidates) async {
    List<Map<String, dynamic>> results = [];

    for (int i = 0; i < textControllers.length; i++) {
      results.add({
        'election_prez_id':
            _presidentialCandidates[i].electionPrezId.toString(),
