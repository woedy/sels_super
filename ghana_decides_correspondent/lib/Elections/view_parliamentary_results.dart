...
class ViewParliamentaryResultScreen extends StatefulWidget {
  const ViewParliamentaryResultScreen({super.key});

  @override
  State<ViewParliamentaryResultScreen> createState() => _ViewParliamentaryResultScreenState();
}

class _ViewParliamentaryResultScreenState extends State<ViewParliamentaryResultScreen> {
              ...
              if (errorKey != null) {
                WidgetsBinding.instance.addPostFrameCallback((_) {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => ViewParliamentaryResultScreen())
                  );
