...
class ElectionSelectRegion extends StatefulWidget {


  const ElectionSelectRegion({super.key,});



  @override
  State<ElectionSelectRegion> createState() => _ElectionSelectRegionState();
}


class _ElectionSelectRegionState extends State<ElectionSelectRegion> {
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context) => ElectionSelectConstituency(data: _data,)));
                          },
                          child: Container(
