...
class ElectionSelectElectoralArea extends StatefulWidget {
  final data;


  const ElectionSelectElectoralArea({super.key,
    required this.data,
  ...
  @override
  State<ElectionSelectElectoralArea> createState() => _ElectionSelectElectoralAreaState();
}


class _ElectionSelectElectoralAreaState extends State<ElectionSelectElectoralArea> {
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context) => ElectionSelectPollingStation(data: _data,)));
                          },
                          child: Container(
