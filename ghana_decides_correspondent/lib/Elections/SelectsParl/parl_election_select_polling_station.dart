...
import 'package:ghd_correspondent/Elections/Results/enter_parliamentary_results2.dart';
...
class ParlElectionSelectPollingStation extends StatefulWidget {
  final data;


  const ParlElectionSelectPollingStation({super.key,
    required this.data,
  ...
  @override
  State<ParlElectionSelectPollingStation> createState() => _ParlElectionSelectPollingStationState();
}


class _ParlElectionSelectPollingStationState extends State<ParlElectionSelectPollingStation> {
  ...
  Widget build(BuildContext context) {
    print(widget.data["constituency_id"]);
                        ...
                        InkWell(
                          onTap: () {
                            var _data = {
                              ...
                              "constituency_id": widget.data['constituency_id'],
                            };
                            Navigator.push(context, MaterialPageRoute(builder: (context) => EnterParliamentaryResultScreen2(data: _data,)));
                          },
                          child: Container(
