...
import 'package:ghd_correspondent/Elections/SelectsParl/parl_election_select_electoral_area.dart';
...
class ParlElectionSelectConstituency extends StatefulWidget {
  final data;


  const ParlElectionSelectConstituency({super.key,
    required this.data,
  ...
  @override
  State<ParlElectionSelectConstituency> createState() => _ParlElectionSelectConstituencyState();
}


class _ParlElectionSelectConstituencyState extends State<ParlElectionSelectConstituency> {
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context) => ParlElectionSelectElectoralArea(data: _data)));
                          },
                          child: Container(
