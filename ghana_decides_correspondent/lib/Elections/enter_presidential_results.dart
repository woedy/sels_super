...
class EnterPresidentialResultScreen extends StatefulWidget {
  const EnterPresidentialResultScreen({super.key});

  @override
  State<EnterPresidentialResultScreen> createState() => _EnterPresidentialResultScreenState();
}

class _EnterPresidentialResultScreenState extends State<EnterPresidentialResultScreen> {
              ...
              if (errorKey != null) {
                WidgetsBinding.instance.addPostFrameCallback((_) {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => EnterPresidentialResultScreen())
                  );
