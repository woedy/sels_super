...
class SelectConstituencyReg extends StatefulWidget {
  final data;


  const SelectConstituencyReg({super.key,
    required this.data,
  ...
  @override
  State<SelectConstituencyReg> createState() => _SelectConstituencyRegState();
}


class _SelectConstituencyRegState extends State<SelectConstituencyReg> {
        ...
        child: SafeArea(
          child: Column(
            children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Select Constituency you’ve been assigned to",
              ...
              InkWell(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => SelectElectoralAreaReg(data: {},)));
                },
                child: Container(
