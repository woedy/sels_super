...
import 'package:ghd_correspondent/Auth/Register/station_details.dart';
...
class SelectPollingStationReg extends StatefulWidget {
  final data;


  const SelectPollingStationReg({super.key,
    required this.data,
  ...
  @override
  State<SelectPollingStationReg> createState() => _SelectPollingStationRegState();
}


class _SelectPollingStationRegState extends State<SelectPollingStationReg> {
        ...
        child: SafeArea(
          child: Column(
            children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Select Polling Station you’ve been assigned to",
              ...
              InkWell(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => SelectStationDetailsReg(data: {},)));
                },
                child: Container(
